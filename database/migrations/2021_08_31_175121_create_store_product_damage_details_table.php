...
class CreateStoreProductDamageDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('store_product_damage_details', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->bigInteger('store_product_damage_id')->unsigned();
    ...
    {
        Schema::dropIfExists('store_product_damage_details');
    }
}
