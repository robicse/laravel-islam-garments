...
class CreateProductSaleExchangeDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('product_sale_exchange_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('product_sale_exchange_details');
    }
}
